...
from model.kan import KANLinear, KAN
from model.ConditionallyParameterizedConvolutions import CondConv2D
...
class UKAN(nn.Module):
    def __init__(self, num_classes=2, input_channels=3, deep_supervision=False, img_size=224, patch_size=16, in_chans=3,
    ...
    def forward(self, x):
      ...
      #  print('1-----------', x.shape)
        ...
        t1 = out
      #  print('2-----------', out.shape, t1.shape)
        ### Stage 2
        out = F.relu(F.max_pool2d(self.encoder2(out), 2, 2))
        t2 = out
       # print('3-----------', out.shape, t2.shape)
        ### Stage 3
        out = F.relu(F.max_pool2d(self.encoder3(out), 2, 2))
        t3 = out
      #  print('4-----------', out.shape, t3.shape)
        ### Tokenized KAN Stage
        ### Stage 4
      ...
      #  print('5-----------', out.shape, H, W)
        for i, blk in enumerate(self.block1):
            out = blk(out, H, W)
        out = self.norm3(out)
       # print('5-----00------', out.shape, H, W)

        out = out.reshape(B, H, W, -1).permute(0, 3, 1, 2).contiguous()
        t4 = out
     #   print('6-----------', out.shape, t4.shape)
        ### Bottleneck
      ...
      #  print('encoding over-----------------')
        ...
        # print('encoding over-----------------', out.shape)
        out = out.view(out.size(0), -1)
        # print('encoding over1-----------------', out.shape)
        out = self.linear(out)
        return out
...
def bk(in_channels, num_classes):
    return UKAN(input_channels=in_channels, num_classes=num_classes)
